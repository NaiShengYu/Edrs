...
@interface EmergencyPlanListViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
...
@implementation EmergencyPlanListViewController
...
- (void)makeDataWithFirst:(BOOL) isFirst{
    ...
    [CustomHttp httpPost:[NSString stringWithFormat:@"%@%@",EDRSHTTP,EDRSHTTP_GETCASES_PAGE]
                  params:@{@"typ":@"2", @"pageIndex": [NSString stringWithFormat:@"%ld",(long)self.page],@"searchKey":self.searchKey}
