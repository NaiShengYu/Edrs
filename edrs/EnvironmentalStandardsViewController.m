...
#import "EnvironmentalStandardsViewController.h"
#import "CustomHttp.h"
#import "CasesInfomationViewController.h"//成功案例详情
#import "CustomeSearchView.h"
@interface EnvironmentalStandardsViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
...
@implementation EnvironmentalStandardsViewController
...
- (void)makeDataWithFirst:(BOOL) isFirst{
    ...
    [CustomHttp httpPost:[NSString stringWithFormat:@"%@%@",EDRSHTTP, EDRSHTTP_GETCASES_PAGE]
                  params:@{@"typ":@"3", @"pageIndex": [NSString stringWithFormat:@"%ld",(long)self.page],@"searchKey":self.searchKey}
